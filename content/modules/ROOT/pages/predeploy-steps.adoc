...
[.console-output]
----
PS C:\Users\Administrator> crictl pull mcr.microsoft.com/windows/servercore:ltsc2019
----

This will take a while, but once pulled. It should appear on the node by running `crictl images` on the node.
