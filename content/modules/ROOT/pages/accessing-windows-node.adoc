...
Once you are in, you can see that the containerd process is running.
...
[source,bash,subs="attributes+,+macros"]
----
Get-Process | ?{ $_.ProcessName -match "kube|overlay|containerd" }
----

[.console-output]
----
PS C:\Users\Administrator> Get-Process | ?{ $_.ProcessName -match "kube|overlay|containerd" }

Handles  NPM(K)    PM(K)      WS(K)     CPU(s)     Id  SI ProcessName
-------  ------    -----      -----     ------     --  -- -----------
    307      19    62876      44124     124.34   2524   0 containerd
...
The base Windows Server container image has been prepulled for you. You should be able to see it by running the `crictl images` command in the PowerShell prompt.

[.console-output]
----
PS C:\Users\Administrator> crictl images
IMAGE                                    TAG                 IMAGE ID            SIZE
mcr.microsoft.com/windows/servercore     ltsc2019            715aaeac112d        5.06GB
----
